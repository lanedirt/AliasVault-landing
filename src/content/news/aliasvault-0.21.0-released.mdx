...
Want to help make AliasVault available in the language that you speak (natively)? [Learn how here](https://github.com/aliasvault/aliasvault/blob/main/CONTRIBUTING.md).
...
Explore the full changelog on [GitHub](https://github.com/aliasvault/aliasvault/compare/0.20.0...0.21.0)
