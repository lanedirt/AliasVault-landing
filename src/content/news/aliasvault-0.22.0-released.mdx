...
Want to help make AliasVault available in your native language? [Learn how here](https://github.com/lanedirt/AliasVault/blob/main/CONTRIBUTING.md).
...
Explore the full changelog on [GitHub](https://github.com/lanedirt/AliasVault/compare/0.21.0...0.22.0)
