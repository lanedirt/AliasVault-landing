...
## Get Started with 0.14.0

To upgrade to the latest version, visit our [GitHub release page](https://github.com/lanedirt/AliasVault/releases/tag/0.14.0). The update brings enhanced security and broader browser support to make AliasVault more accessible than ever. 