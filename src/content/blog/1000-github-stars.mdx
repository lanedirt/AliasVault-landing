...
- ⭐ [Star the repo](https://github.com/lanedirt/AliasVault) to show your support
- 🗣 Join our [Discord](https://discord.gg/DsaXMTEtpF) to connect with other users
- 🧪 Try AliasVault via [cloud signup](https://app.aliasvault.net) or [self-host it](https://github.com/lanedirt/AliasVault#self-hosting)
- 🛠 Help shape the future by [contributing ideas, issues, or code](https://github.com/lanedirt/AliasVault/blob/main/CONTRIBUTING.md).
...
Check out what’s ahead on the [v1.0 roadmap](https://github.com/lanedirt/AliasVault/issues/731).
