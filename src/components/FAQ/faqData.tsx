...
const faqData: FAQItem[] = [
  ...
  {
    id: 2,
    question: "Who is AliasVault for?",
    answer: "AliasVault is a password manager built with a strong focus on privacy, making it the ideal choice for privacy-conscious individuals. If you care about controlling your digital identity, avoiding trackers, and reducing your exposure in data breaches, AliasVault helps you manage credentials and aliases securely. All without compromising your privacy.",
  },
  {
    id: 3,
